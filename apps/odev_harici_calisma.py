...
def app():
    ...
    cozulen_sorular=st.text_input(label='Çözülen Sorular Örn.(1-5,10,12-17)',value=sorular,key='cozulen_sorular')
    cozulen_soru_sayisi=st.text_input(label='Çözülen Soru Sayısı',value=soru_sayisi_hesapla(sorular)[1],key='cozulen_soru_sayisi',disabled=True)
